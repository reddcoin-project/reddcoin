...
{
    std::string strSecret = std::string("UzBrVDPAtr6rveJuVA352nDaHivaQqdHpxRkjouTfNFaZjETynAv");
    ...
    std::vector<unsigned char> expected = ParseHex("0364d46c080000000000000001");
