...
void RPCConsole::updateDetailWidget()
{
    ...
    ui->peerLastSend->setText(TimeDurationField(time_now, count_seconds(stats->nodeStats.m_last_send)));
    ui->peerLastRecv->setText(TimeDurationField(time_now, count_seconds(stats->nodeStats.m_last_recv)));
