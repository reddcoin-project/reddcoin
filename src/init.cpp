...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-stakerstartdelay=<n>", "Pause each staking thread for <n> milliseconds before it subscribes to its wallet's unload notification, widening the startup window so an unload can be landed inside it (default: 0)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
