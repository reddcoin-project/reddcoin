...
// Copyright (c) 2020-2024 The Reddcoin Core developers
...
void SQLiteDatabase::Open()
{
    ...
    if (ret != SQLITE_OK) {
        throw std::runtime_error("SQLiteDatabase: Unable to obtain an exclusive lock on the database, is it being used by another reddcoind?\n");
    }
