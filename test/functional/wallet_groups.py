...
class WalletGroupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        with self.nodes[3].assert_debug_log(['Fee non-grouped = 22900, grouped = 37600, using grouped']):
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        with self.nodes[3].assert_debug_log(['Fee non-grouped = 52300, grouped = 81700, using non-grouped']):
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        with self.nodes[4].assert_debug_log(['Fee non-grouped = 52300, grouped = 81700, using grouped']):
