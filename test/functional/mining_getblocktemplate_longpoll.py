...
class LongpollThread(threading.Thread):
    ...
    def run(self):
        try:
            ...
            # The test validates longpoll detection, not template creation.
            pass
...
class GetBlockTemplateLPTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        # Whitelist prevents P2P disconnections from mocktime/realtime mismatch
    ...
    def run_test(self):
        ...
        # Advance mocktime so getblocktemplate can find a new coinstake
        ...
        miniwallets[0].send_self_transfer(from_node=self.nodes[0],
                                          fee_rate=fee_rate)
