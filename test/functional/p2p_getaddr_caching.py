...
class AddrTest(BitcoinTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        # Whitelist test connections to prevent mocktime timeout disconnections
    ...
    def run_test(self):
        # Initialize mocktime from cache block time for ReddCoin PoS compatibility
