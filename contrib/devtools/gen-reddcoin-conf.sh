...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/reddcoin.conf}
...
then
  ...
  echo -e "To safely generate a reddcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example reddcoin.conf file in share/examples/'
...
##
## reddcoin.conf configuration file.
## Generated by contrib/devtools/gen-reddcoin-conf.sh.
##
...
# parse the output from reddcoind --help
