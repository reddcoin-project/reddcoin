Contributing to Reddcoin Core
============================

The Reddcoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Reddcoin Core
...
Before you start contributing, familiarize yourself with the Reddcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Reddcoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
Most communication about Reddcoin Core development happens on IRC, in the
...
For all other issues and pull requests, the https://github.com/reddcoin-project/reddcoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to reddcoin-qt
...
fork of Reddcoin Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Reddcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Reddcoin
Network Protocol consensus changes.

Whether a pull request is merged into Reddcoin Core rests with the project merge
...
Patches that change Reddcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Reddcoin consensus, it must have been
...
The project leader is the release manager for each Reddcoin Core release.
