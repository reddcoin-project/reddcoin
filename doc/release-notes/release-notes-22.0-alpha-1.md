...
Reddcoin Core version 22.0 alpha 1 is available from:

  <https://https://download.reddcoin.com/bin/reddcoin-core-4.22.0/alpha/8aebab86b834/>
...
Reddcoin Core version 22.0 alpha 1 is intended to run on testnet only.
...
**WARNING:** This is an alpha release of Reddcoin Core version 22.0, by running this version you acknowledge that there
